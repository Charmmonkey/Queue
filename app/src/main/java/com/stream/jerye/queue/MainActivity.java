...
public class MainActivity extends AppCompatActivity implements SpotifyPlayer.NotificationCallback, ConnectionStateCallback, Search.View{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (response.getType() == AuthenticationResponse.Type.TOKEN) {
                ...
                mActionListener.refreshToken(mToken);
